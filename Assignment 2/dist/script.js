...
const display = (statement, output) => {
    ...
    if (result)
        result.innerHTML = "<p class='text-center'>" + output + "</p>";
};
...
const askNameFromUser = () => {
    var _a;
    const name = (_a = prompt("Enter your name")) !== null && _a !== void 0 ? _a : "";
    alert(name);
...
const compareNumbers = () => {
    ...
    const html = 'const num1: number = Number(prompt("Enter a number")); <br> const num2: number = Number(prompt("Enter another number"));';
    if (num1 > num2) {
...
const ifNested = () => {
    ...
    const html = 'const age: number = Number(prompt("Enter your age")); <br> const weight: number = Number(prompt("Enter your weight"));';
...
const login = () => {
    var _a, _b;
    const email = (_a = prompt("Enter your email")) !== null && _a !== void 0 ? _a : "";
    if (!email)
        return alert("Please enter email");
    const password = (_b = prompt("Enter your password")) !== null && _b !== void 0 ? _b : "";
    if (!password)
        return alert("Please enter password");
    const html = 'const email: string = prompt("Enter your email") ?? ""; <br> const password: string = prompt("Enter your password") ?? "";';
